        ...
        private void Run_button_Click(object sender, EventArgs e)
        {
            ...
            else if (radioButton3.Checked)
            {
                ...
                if (triangle.ExistTriangle) { listView1.Items[6].SubItems.Add("Существует"); }
                    ...
                    if (triangle.ravnbedr) { listView1.Items[7].SubItems.Add("Равнобедренный");}
                    if (triangle.ravn) { listView1.Items[7].SubItems.Add("Равносторонний"); }
                    if (triangle.razn) { listView1.Items[7].SubItems.Add("Разносторонний"); }
